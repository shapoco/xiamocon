...
typedef enum {
  ...
  XMC_ERR_I2C_BUS_RESET_FAILED = XMC_ERR_BASE_I2C + 2,
  ...
  XMC_ERR_PWM_UPDATE_FAILED = XMC_ERR_BASE_PWM + 2,
  XMC_ERR_BASE_MULTICORE = 0x900,
  XMC_ERR_MULTICORE_ALREADY_RUNNING = XMC_ERR_BASE_MULTICORE + 1,
  XMC_ERR_MULTICORE_LAUNCH_FAILED = XMC_ERR_BASE_MULTICORE + 2,
  XMC_ERR_MULTICORE_STOP_FAILED = XMC_ERR_BASE_MULTICORE + 3,
  XMC_ERR_BASE_FLASH = 0xA00,
  XMC_ERR_FLASH_INIT_FAILED = XMC_ERR_BASE_FLASH + 1,
  XMC_ERR_FLASH_ERASE_FAILED = XMC_ERR_BASE_FLASH + 2,
  XMC_ERR_FLASH_WRITE_FAILED = XMC_ERR_BASE_FLASH + 3,
  XMC_ERR_FLASH_MMAP_FAILED = XMC_ERR_BASE_FLASH + 4,
