...
typedef enum {
  ...
  XMC_ERR_FS_OPEN_FAILED = XMC_ERR_BASE_FILESYSTEM + 4,
  XMC_ERR_FS_CLOSE_FAILED = XMC_ERR_BASE_FILESYSTEM + 5,
  XMC_ERR_FS_READ_FAILED = XMC_ERR_BASE_FILESYSTEM + 6,
  XMC_ERR_FS_WRITE_FAILED = XMC_ERR_BASE_FILESYSTEM + 7,
  XMC_ERR_FS_SEEK_FAILED = XMC_ERR_BASE_FILESYSTEM + 8,
  XMC_ERR_FS_NOT_OPENED = XMC_ERR_BASE_FILESYSTEM + 9,
  XMC_ERR_FS_OPERATION_FAILED = XMC_ERR_BASE_FILESYSTEM + 10,
