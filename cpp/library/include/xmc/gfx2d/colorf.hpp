...
struct colorf {
  ...
  XMC_INLINE constexpr colorf() : r(0), g(0), b(0), a(0) {}
  XMC_INLINE constexpr colorf(float r, float g, float b, float a)
      : r(r), g(g), b(b), a(a) {}
  ...
  XMC_INLINE constexpr uint16_t to565() const {
    return clipPack565(this->r * 31.0f, this->g * 63.0f, this->b * 31.0f);
  }

  XMC_INLINE constexpr colorf operator+(const colorf &other) const {
  ...
  XMC_INLINE constexpr colorf operator*(int scalar) const {
    return colorf(r * scalar, g * scalar, b * scalar, a * scalar);
  }

  XMC_INLINE constexpr colorf operator*(float scalar) const {
    return colorf(r * scalar, g * scalar, b * scalar, a * scalar);
  }
  ...
  XMC_INLINE constexpr colorf operator/(int scalar) const {
    ...
    return colorf(r * invScalar, g * invScalar, b * invScalar, a * invScalar);
  }
