...
static inline xmc_sample_format_t xmc_speaker_get_supported_formats(void) {
  return xmc_sdac_get_supported_formats();
}

xmc_status_t xmc_speaker_init(xmc_sample_format_t format, uint32_t sample_rate_hz, uint32_t latency_samples,
